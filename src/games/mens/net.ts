...
/** Auto-reconnecting WebSocket link to the Mens erger je niet worker. */
...
export const MENS_HOST =
  (ENV.PUBLIC_MENS_HOST as string | undefined) ||
  (ENV.DEV ? 'localhost:8792' : 'empyr-mens.arcanearthenden.workers.dev');
...
const KEY_STORE = 'mens.player.key';
const NAME_STORE = 'mens.player.name';
