...
/** Auto-reconnecting WebSocket link to the draughts worker. */
...
const KEY_STORE = 'draughts.player.key';
const NAME_STORE = 'draughts.player.name';

/** Stable per-tab identity, so a refresh reclaims the same seat and clock. */
