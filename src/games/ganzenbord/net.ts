...
/** Auto-reconnecting WebSocket link to the Ganzenbord worker. */
...
const KEY_STORE = 'ganzenbord.player.key';
const NAME_STORE = 'ganzenbord.player.name';

/** Stable per-tab identity so a refresh reclaims the same pawn. */
