...
export const medreseCopy = {
  nl: {
    ...
    adminLink: 'Beheer',
    adminTitle: 'Medrese beheer',
    adminSubtitle: 'Voeg artikelen, video’s en podcasts toe aan de demo.',
    adminLogin: 'Inloggen',
    adminEmail: 'E-mailadres',
    adminPassword: 'Wachtwoord',
    adminDemoHint: 'Demo: admin@medrese.demo / medrese-demo',
    adminInvalid: 'Onjuiste inloggegevens.',
    ...
    adminEmpty: 'Nog geen items. Voeg je eerste artikel, video of podcast toe.',
    adminTypePost: 'Artikel',
    adminTypeVideo: 'Video',
    adminTypePodcast: 'Podcast',
    adminTitleLabel: 'Titel',
    adminSummaryLabel: 'Samenvatting',
    adminMetaLabel: 'Meta (bijv. duur of datum)',
    adminTagsLabel: 'Tags (komma-gescheiden)',
    adminSourceLabel: 'Bron (optioneel)',
    adminMediaLabel: 'Video/podcast URL (optioneel)',
    adminPublished: 'Opgeslagen in deze browser.',
    adminDeleteConfirm: 'Dit item verwijderen?',
    adminBackSite: 'Terug naar Medrese',
  },
  tr: {
    siteName: 'Medrese',
    navLearn: 'Öğren',
    ...
    adminLink: 'Yönetim',
    adminTitle: 'Medrese yönetimi',
    adminSubtitle: 'Demo sitesine makale, video ve podcast ekleyin.',
    adminLogin: 'Giriş yap',
    adminEmail: 'E-posta',
    adminPassword: 'Şifre',
    adminDemoHint: 'Demo: admin@medrese.demo / medrese-demo',
    adminInvalid: 'Geçersiz giriş bilgileri.',
    adminDashboard: 'Panel',
    adminLogout: 'Çıkış',
    adminNew: 'Yeni içerik',
    adminEdit: 'Düzenle',
    adminDelete: 'Sil',
    adminSave: 'Kaydet',
    adminCancel: 'İptal',
    adminEmpty: 'Henüz içerik yok. İlk makale, video veya podcast’inizi ekleyin.',
    adminTypePost: 'Makale',
    adminTypeVideo: 'Video',
    adminTypePodcast: 'Podcast',
    adminTitleLabel: 'Başlık',
    adminSummaryLabel: 'Özet',
    adminMetaLabel: 'Meta (süre veya tarih)',
    adminTagsLabel: 'Etiketler (virgülle ayırın)',
    adminSourceLabel: 'Kaynak (isteğe bağlı)',
    adminMediaLabel: 'Video/podcast URL (isteğe bağlı)',
    adminPublished: 'Bu tarayıcıda kaydedildi.',
    adminDeleteConfirm: 'Bu içerik silinsin mi?',
    adminBackSite: 'Medrese’ye dön',
  },
  en: {
    siteName: 'Medrese',
    navLearn: 'Learn',
    ...
    adminLink: 'Admin',
    adminTitle: 'Medrese admin',
    adminSubtitle: 'Add articles, videos and podcasts to the demo site.',
    adminLogin: 'Sign in',
    adminEmail: 'Email address',
    adminPassword: 'Password',
    adminDemoHint: 'Demo: admin@medrese.demo / medrese-demo',
    adminInvalid: 'Invalid login credentials.',
    adminDashboard: 'Dashboard',
    ...
    adminSave: 'Save',
    adminCancel: 'Cancel',
    adminEmpty: 'No items yet. Add your first article, video or podcast.',
    adminTypePost: 'Article',
    adminTypeVideo: 'Video',
    adminTypePodcast: 'Podcast',
    adminTitleLabel: 'Title',
    adminSummaryLabel: 'Summary',
    adminMetaLabel: 'Meta (e.g. duration or date)',
    adminTagsLabel: 'Tags (comma-separated)',
    adminSourceLabel: 'Source (optional)',
    adminMediaLabel: 'Video/podcast URL (optional)',
    adminPublished: 'Saved in this browser.',
    adminDeleteConfirm: 'Delete this item?',
    adminBackSite: 'Back to Medrese',
  },
} as const;
